        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute left-1/2 -translate-x-1/2 -bottom-4 sm:left-auto sm:translate-x-0 sm:bottom-auto sm:top-8 sm:-right-8 z-20 bg-[var(--text-heading)] text-white rounded-2xl px-5 py-4 shadow-[0_8px_32px_rgba(31,42,68,0.18)]"
            >
