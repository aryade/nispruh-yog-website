...
const EVENTS: Event[] = [
  ...
  {
    id: "mantra-meditation-august",
    type: "Workshop",
    title: "Mantra and Meditation",
    subtitle: "An evening of practice open to all",
    dateLabel: "15 August 2026",
    dateISO: "2026-08-15",
    location: "Espoo, Finland",
    locationDetail: "Penhtorintie 3, 02490 Espoo (Järvenperä)",
    duration: "2.5 hours · 5:00 PM – 7:30 PM",
    spotsLeft: 12,
    spotsTotal: 20,
    price: "Sliding scale",
    description:
      "An evening gathering for mantra chanting and guided meditation. This session welcomes practitioners of all levels — those new to Kriya Yoga and experienced students alike. We will explore the transformative power of mantras and rest in collective silence.",
    highlights: [
      "Open to all levels",
