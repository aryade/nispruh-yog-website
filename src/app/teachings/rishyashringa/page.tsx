      ...
      <main className="py-16">
        <div className="mx-auto max-w-4xl px-5 sm:px-8">
          ...
          <article className="prose prose-sm max-w-none text-[var(--text-body)] mt-12">
            ...
            <h2>A Terrible Famine in the Kingdom of Anga</h2>
            ...
            <h2>The Putrakameshti Sacrifice</h2>
            ...
            <ul>
              <li>True austerity and purity of character become a source of welfare for society.</li>
              <li>Innocence is a great virtue, but it should be accompanied by wisdom and discernment.</li>
              <li>Through righteousness and spiritual discipline, even seemingly impossible tasks can be accomplished.</li>
              <li>Great sages do not live merely for themselves—they dedicate their lives to the welfare of the entire world.</li>
              <li>Every individual has a unique and meaningful role in the divine plan.</li>
            </ul>
