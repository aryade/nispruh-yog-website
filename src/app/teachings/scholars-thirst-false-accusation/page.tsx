      ...
      <main className="py-16">
        <div className="mx-auto max-w-4xl px-5 sm:px-8">
          ...
          <article className="prose prose-sm max-w-none text-[var(--text-body)] mt-12">
            ...
            <blockquote>
              <p>
                "Keep the company of the virtuous,<br />
                As one stays near a perfumer.<br />
                Even if he gives you no perfume,<br />
            ...
            <p>
              This ancient story speaks to a timeless truth: <strong>The corruption of virtue is the most dangerous form of manipulation.</strong>
            </p>
            ...
            <p>
              The scholar studied all the scriptures. Yet his knowledge could not protect him from someone who had mastered the art of twisting truth. This is why the teaching does not end with wisdom or philosophy—it ends with a simple, practical instruction: <strong>Know who you are with.</strong>
            </p>
            ...
            <p>
              Similarly, keep the company of those who are genuinely sincere. Not those who speak of virtue, but those who <em>embody</em> it. Not those who are perfect, but those whose imperfections come from honest striving, not from calculated deception.
            </p>

            <p>
              The world today is full of false teachers and manipulators wrapped in the language of righteousness. They will beat you with your own goodness if it serves them. The only defense is not intellectual—it is relational. <strong>Choose your company with your life.</strong>
            </p>
